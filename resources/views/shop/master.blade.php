...
<head>
  ...
  <link rel="icon" style="border-radius:50%" href="{{ asset('public/image/favi.png') }}" type="image/gif" sizes="16x16">
...
<div class="wrapper">
 ...
 @php $world=DB::table('companies')->first(); @endphp
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">{{$world->name}}</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Develop By</b> <a href="http://www.lssoft.xyz/" target="blank">LS Soft</a>
    </div>
  </footer>
