...
<div class="page-content fade-in-up">
    ...
    <form enctype="multipart/form-data" action="{{route('admin.loan.store')}}" method="post">
      @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <form enctype="multipart/form-data" action="{{route('admin.loan.update')}}" method="post" >
            @csrf
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-12 form-group">
        ...
        <div class="card-body">
          <div class="table-responsive">
           <table id="example" class="table table-bordered table-hover ">
             ...
             <tr>
                 @php $check=DB::table('users')->find($blog->user) @endphp
              <td>{{@$check->name}} <br> {{@$check->mobile}}</td>
              <td>{{$blog->name}}</td>
              <td>{{$blog->mobile}}</td>
              <td>{{$blog->address}}</td>
